...
<body class="bg-color-rosa">
	<form id="login" action="" method="post" class="panel panel-warning">
		...
		<div class="panel-body">
			...
			<div class="form-group"
				style="margin-left: 30%; width: 250px; height: 50px;">
				<input type="submit" class="btn btn-success" value="Acessar"> <input
					type="reset" class="btn btn-cancel" value="Cancelar">
				<div style="margin-left: 50%; margin-top: 20px; float: rigth;">
					<a href="" class="label label-warning hidden">Esqueci a senha!</a>
				</div>
			</div>
		</div>
	</form>
