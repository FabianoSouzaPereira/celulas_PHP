...
<div class="container-fluid pb-5 mb-3">
	<div>
		<div class="mt-2">
			<a href="index.php?pag=site_view_churchReadView" id="voltar"
			...
			<form action="" method="post" accept-charset="UTF-8">
				<div class="layoutPadrao panel-body" style="margin-top: 20px;">
					<div class="panel-heading" style="margin-top: -20px;">
						<h2 class="text-muted">Criar nova Igreja</h2>
					</div>
					<div>
						<div class="form-row" style="margin-top: -10px;">
							<div id="id" class="">
								<input type="hidden" name="celId" id="id"
									value="<?php echo @$ret[0]['chuId'];?>" class="">
							</div>
							<div id="celula" class="form-group col-md-6"
								style="margin-top: 30px; margin-left: 0%;">
								<label class="text-muted" for="igreja">Igreja</label> <input type="text"
									name="chuIgreja" id="igreja"
									value="<?php echo @$ret[0]['chuIgreja']; ?>"
									onkeyup="maiuscula(this)" class="form-control">
							</div>
							<div id="endereco" class="form-group col-md-6"
								style="margin-top: 30px; margin-left: 0%;">
								<label class="text-muted" for="endereco">Endereco</label> <input type="text"
									name="chuEndereco" id="endereco"
									value="<?php echo @$ret[0]['chuEndereco']; ?>"
									onkeyup="maiuscula(this)" class="form-control">
							</div>
						</div>
						<div class="form-row">
							<div id="bairro" class="form-group col-md-6">
								<label class="text-muted" for="bairro">Bairro</label> <input type="text"
									name="chuBairro" id="bairro"
									value="<?php echo @$ret[0]['chuBairro'];?>"
									onkeyup="maiuscula(this)" class="form-control">
							</div>
							<div id="cidade" class="form-group col-md-6">
								<label class="text-muted" for="cidade">Cidade</label> <input type="text"
									name="chuCidade" id="cidade"
									value="<?php echo @$ret[0]['chuCidade'];?>"
									onkeyup="maiuscula(this)" class="form-control">
							</div>
						</div>
						<div class="form-row">
							<div id="estado" class="form-group col-md-6"
								style="margin-left: 0%;">
								<label class="text-muted" for="estado">Estado</label> <input type="text"
									name="chuEstado" id="estado"
									value="<?php echo @$ret[0]['chuEstado'];?>"
									onkeyup="maiuscula(this)" class="form-control">
							</div>
							<div id="pais" class="form-group col-md-6">
								<label for="pais">País</label> <input type="text" name="chuPais"
									id="pais" value="<?php echo @$ret[0]['chuPais'];?>"
									onkeyup="maiuscula(this)" class="form-control">
							</div>
						</div>
						<div class="form-row">
							<div id="cep" class="form-group col-md-2">
								<label for="cep">Cep</label> <input type="number" name="chuCep"
									id="cep" value="<?php echo @$ret[0]['chuCep'];?>"
									onkeyup="maiuscula(this)" class="form-control">
							</div>
						</div>
						<div class="form-row">
							<div id="data" class="form-group col-md-2">
								<label class="text-muted" for="data">Data da Criação</label> <input type="text"
									name="chuData" id="data" value="<?php echo  date('d/m/Y'); ?>"
									class="form-control mascaraData">
							</div>
							<div id="telefone" class="form-group col-md-2">
								<label class="text-muted" for="telefone">Telefone</label> <input type="text"
									name="chuTelefone" id="telefone"
									value="<?php echo  @$ret[0]['chuTelefone']; ?>"
									pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4,5}"
									class="form-control mascaraTelefone"
									placeholder="Digite o telefone">
							</div>
						</div>
						<div class="form-row">
							<div id="email" class="form-group col-md-6">
								<label class="text-muted" for="email">Email</label> <input type="email"
									name="chuEmail" id="email"
									value="<?php echo  @$ret[0]['chuEmail']; ?>"
									class="form-control">
							</div>
							<div id="regiao" class="form-group col-md-4">
								<label>Região</label> <select id="regiao" name="chuRegiao"
						...
						<div class="submitting  nav justify-content-center" style="margin: 30px auto 50px auto">
							<input id="enviar" type="submit" class="left btn btn-success mt-4 col-md-2"
								value="Enviar"> <input id="cancelar" type="submit"
								name="cancelar" class="right btn btn-default border mt-4 ml-2 col-md-2" value="Cancelar">
						</div>
					</div>
				</div>
			</form>
