...
if(isset($_GET['id'])){
    ...
    switch ($logtipo) {
                case 1: $igr->adminReadWholeByid($id);
                        $ret = $igr->getDados();
                   break;
                case 2: $igr->coordenadorReadWholeByid($id);
                        $ret = $igr->getDados();
                   break;
                case 3: $igr->pastorReadWholeByid($id);
                        $ret = $igr->getDados();
                   break;
                case 4: $igr->liderReadWholeByid($id);
                        $ret = $igr->getDados();
                   break;
                case 5: $igr->colaboradorReadWholeByid($id);
                        $ret = $igr->getDados();
                   break;
                case 6: $igr->comumReadWholeByid($id);
                        $ret = $igr->getDados();
                   break;
                case 7: '0';
                   break;
