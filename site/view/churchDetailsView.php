...
<div class="panel-heading" style="margin-top: -20px;">
	<h2 class="text-muted">Detalhes da Igreja   &nbsp;&nbsp;&nbsp;<b><?php echo @$ret[0]['chuIgreja']; ?></b></h2>
</div>
<div>
  <div class="form-row" style="margin-top: -10px;"> 
      ...
      <div id="celula" class="form-group col-md-6" style="margin-top: 30px;margin-left: 0%;">
        	<label text-muted for="igreja">Igreja</label>
      ...
      <div id="endereco" class="form-group col-md-6" style="margin-top: 30px;margin-left: 0%;">
        	<label text-muted for="endereco">Endereco</label>
   ...
   <div class="form-row">
      <div id="bairro" class="form-group col-md-6" >
        	<label text-muted for="bairro">Bairro</label>
      ...
      <div id="cidade" class="form-group col-md-6">
        	<label text-muted for="cidade">Cidade</label>
    ...
    <div class="form-row">
        <div id="cep" class="form-group col-md-2">
        	<label class="text-muted" for="cep">Cep</label>
   ...
   <div class="form-row" >
        <div id="data" class="form-group col-md-2">
        	<label class="text-muted" for="data">Data da Criação</label>
        ...
        <div id="telefone" class="form-group col-md-2">
        	<label class="text-muted" for="telefone">Telefone</label>
        ...
        <div id="regiao" class="form-group col-md-4">
                <label class="text-muted" for="regiao">Região</label><span><?php $regiao= @$ret[0]['chuRegiao'];?></span>
