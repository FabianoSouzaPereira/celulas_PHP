	...
	<div class="container">
		<div class="navbar-header" style="margin-left: -75px;">
			...
			<a class="navbar-brand" href="index.php"> <span
				class="glyphicon glyphicon-globe"> </span> IGREJA EM CÉLULAS
			</a>
		</div>
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a id="link-user" title="Clique aqui para realizar o acesso"
					href="" data-toggle="modal" data-target="#modal-login"> <span
						class="glyphicon glyphicon-user"><label class="acessoSmart"
							style='display: none'> Acessar</label> </span> <!-- Acesso -->
				</a></li>
				<li><a href="" data-toggle="modal" data-target="#modal-pesquisa"><span
						class="glyphicon glyphicon-search"><label class="acessoSmart"
							style='display: none'> Pesquisar</label> </span></a></li>
			...
			<div class="modal-body">
				<form action="" class="form-inline">
					<input value="<?php echo @$_GET['p']; ?>" type="text" name="p"
						...
						placeholder="Pesquise por nome descricao ou categoria.">
