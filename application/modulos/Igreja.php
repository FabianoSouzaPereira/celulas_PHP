   ...
   /** Inicio funcoes admin */
    ...
    public function readWholeByid($id_)
    {
        ...
        try{
            ...
            GROUP BY
                chuId
            HAVING chuId = '$id_' 
            AND (chuLevel >= '$tipo' OR chuId IN(SELECT igreja FROM tabela_acesso_igreja WHERE usuario = '$id' AND status = '1' ))   
            ORDER BY
                chuId
            LIMIT 1;";
    ...
    public function insert()
    {
        ...
        try {
            ...
            $tipo = $_SESSION['tipo'];
            $userId = $_SESSION['id'];
            $query = "INSERT INTO igrejas (chuId,chuuid,chuIgreja,chuEndereco,chuBairro,chuCidade,chuEstado,chuPais,chuCep,chuData,chuTelefone,chuEmail,chuRegiao,chuLevel,chuuserId,chuStatus)"
                ."values(:chuId,:chuuid,:chuIgreja,:chuEndereco,:chuBairro,:chuCidade,:chuEstado,:chuPais,:chuCep,:chuData,:chuTelefone,:chuEmail,:chuRegiao,:chuLevel,:chuuserId,:chuStatus);";
    ...
    try{
        ...
        $query="SELECT chuId,"
             ...
             ."HAVING chuStatus = '1' AND " 
                ."chuId IN(SELECT igreja FROM tabela_acesso_igreja "
                        ."WHERE usuario = '$id' AND level >= '$tipo') "   
            ."ORDER BY chuId "
            ."LIMIT 1001;";
            $stmt = $conn = new Connection();
            $stmt = $conn->getInstance()->prepare($query);
    ...
    public function pastorInsert()
    {
        ...
        try {
            ...
            $query = "INSERT INTO igrejas (chuuid,chuIgreja,chuEndereco,chuBairro,chuCidade,chuEstado,chuPais,chuCep,chuData,chuTelefone,chuEmail,chuRegiao,chuLevel,chuuserId,chuStatus)"
                ."values(:chuuid,:chuIgreja,:chuEndereco,:chuBairro,:chuCidade,:chuEstado,:chuPais,:chuCep,:chuData,:chuTelefone,:chuEmail,:chuRegiao,:chuLevel,:chuuserId,:chuStatus);";
