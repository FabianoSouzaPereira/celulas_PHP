...
class Celula
{
    ...
    function updateCelulaforId($id){
        ...
        try {
            ...
            $stmt->bindValue(':celEndereco', $this->getEndereco());
            $stmt->bindValue(':celBairro', $this->getBairro());
            $stmt->bindValue(':celCidade', $this->getCidade());
            $stmt->bindValue(':celEstado', $this->getEstado());
            $stmt->bindValue(':celPais', $this->getPais());
            $stmt->bindValue(':celCep', $this->getCep());
