<?php
namespace application\modulos\dao;
...
final class Connection
{
    ...
    private static $host = "127.0.0.1";    //sql246.main-hosting.eu

    private static $port = "3306";         //3306

    private static $user = "u564016761_nPzXe";         //u564016761_root

    private static $password = "5jard#secret";        //5jard#secret

    private static $db = "u564016761_celulasDB";     //u564016761_celulasDB
